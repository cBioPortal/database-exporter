...
def dataset_card(
    ...
    lines.extend(
        [
            ...
            "## Current snapshot",
            "",
            f"- Source dump: [{dump_dir}]({source_url}/)",
            ...
            "The source dump remains available from the cBioPortal public database",
            "dump site.",
            "",
            "## Usage",
            "",
            ...
            "## Data scope",
            "",
            "This publication follows the same scope as the public S3 dump. The",
            "exporter excludes authentication, user, token, session, password,",
            "credential, and secret-related tables before creating the snapshot.",
            "",
            "For help, contact cbioportal@googlegroups.com.",
            "",
        ]
    )
    return "\n".join(lines)
